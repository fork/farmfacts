...
">"}if(xhtmlFormatting=="formatted"&&f&&f.toLowerCase()!="br"&&window.xhtmljs.tagIsLineBreaking(f)){e+="\n";for(d=0;d<c;d++)e+="\t"}e=e.replace(/<>/,"").replace(/< \/>/,"");return e.replace(/\s*\n(\t*)\s*\n/g,"\n$1")}else return a.nodeValue?a.nodeType&&a.nodeType==8?"<!--"+a.nodeValue.trim()+"--\>":a.nodeValue.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):a.toString().indexOf("[object")!=0?a.toString().trim().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""},xmlAttributeEncode:function(a){return xmlEncode(a)},
