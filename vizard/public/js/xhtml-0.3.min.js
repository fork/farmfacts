...
">"}if(xhtmlFormatting=="formatted"&&f&&f.toLowerCase()!="br"&&window.xhtmljs.tagIsLineBreaking(f)){e+="\n";for(d=0;d<c;d++)e+="\t"}e=e.replace(/<>/,"").replace(/< \/>/,"");return e.replace(/\s*\n(\t*)\s*\n/g,"\n$1")}else return a.nodeValue?a.nodeType&&a.nodeType==8?"<!--"+a.nodeValue+"--\>":a.nodeValue.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):a.toString().indexOf("[object")!=0?a.toString().trim().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""},xmlAttributeEncode:function(a){return xmlEncode(a)},
xmlEncode:function(a){return a.replace(/&/g,"&amp;").replace(/\"/g,"&quot;")},tagIsLineBreaking:function(a){if(!a)return false;switch(a.toLowerCase()){case "h1":case "h2":case "h3":case "h4":case "h5":case "h6":case "br":case "p":case "div":case "table":case "blockquote":case "ul":case "ol":return true;default:return false}},tagInXhtml:function(a){switch(a){case "DOCTYPE":case "doctype":case "html":case "head":case "base":case "meta":case "title":case "script":case "style":case "link":case "body":case "iframe":case "frameset":case "frame":case "a":case "abbr":case "acronym":case "area":case "b":case "bdo":case "big":case "blockquote":case "br":case "button":case "caption":case "cite":case "code":case "col":case "colgroup":case "dd":case "del":case "dfn":case "div":case "dl":case "dt":case "em":case "fieldset":case "form":case "h1":case "h2":case "h3":case "h4":case "h5":case "h6":case "hr":case "i":case "img":case "input":case "ins":case "kbd":case "label":case "legend":case "li":case "map":case "noscript":case "object":case "option":case "optgroup":case "ol":case "p":case "param":case "pre":case "q":case "samp":case "select":case "span":case "small":case "strong":case "sub":case "sup":case "table":case "tbody":case "td":case "textarea":case "tfoot":case "th":case "thead":case "tr":case "tt":case "u":case "ul":case "var":return true;
...
default:return false}case "checked":return c=="checked";case "disabled":return c=="disabled";case "readonly":return c=="readonly";case "name":case "value":case "maxlength":case "src":case "alt":case "accept":case "accesskey":case "tabindex":return true;default:return false}case "ins":switch(b){case "cite":case "datetime":return true;default:return false}case "label":switch(b){case "for":case "accesskey":return true;default:return false}case "legend":switch(b){case "accesskey":return true;default:return false}case "link":switch(b){case "media":switch(c){case "screen":case "print":case "projection":case "braille":case "speech":case "all":return true;
default:return false}case "href":case "charset":case "hreflang":case "type":case "rel":case "rev":return true;default:return false}case "map":return false;case "meta":switch(b){case "content":case "name":case "http-equiv":case "scheme":return true;default:return false}case "optgroup":switch(b){case "disabled":return c=="disabled";case "label":return true;default:return false}case "option":switch(b){case "selected":return c=="selected";case "value":return true;default:return false}case "param":switch(b){case "name":case "value":case "type":case "valuetype":return true;
default:return false}case "q":switch(b){case "cite":return true;default:return false}case "script":switch(b){case "type":case "src":case "charset":case "defer":return true;default:return false}case "select":switch(b){case "multiple":return c=="multiple";case "disabled":return c=="disabled";case "name":case "size":case "tabindex":return true;default:return false}case "style":switch(b){case "type":case "media":case "title":case "dir":case "xml:lang":case "lang":return true;default:return false}case "table":switch(b){case "border":case "cellpadding":case "cellspacing":case "frame":case "rules":case "width":case "summary":return true;
default:return false}case "thead":case "tbody":case "tfoot":case "tr":switch(b){case "align":switch(c){case "left":case "center":case "right":case "justify":case "char":return true;default:return false}case "valign":switch(c){case "top":case "middle":case "bottom":case "baseline":return true;default:return false}case "char":case "charoff":return true;default:return false}case "td":case "th":switch(b){case "align":switch(c){case "left":case "center":case "right":case "justify":case "char":return true;
default:return false}case "valign":switch(c){case "top":case "middle":case "bottom":case "baseline":return true;default:return false}case "abbr":case "axis":case "char":case "charoff":case "colspan":case "headers":case "rowspan":case "scope":return true;default:return false}case "textarea":switch(b){case "disabled":return c=="disabled";case "readonly":return c=="readonly";case "rows":case "cols":case "name":case "accesskey":case "tabindex":return true;default:return false}default:return false}}};
if(!window.xhtmlFormatting)window.xhtmlFormatting="formatted";if(String.prototype&&!String.prototype.trim)String.prototype.trim=function(){return this.replace(/^\s\s*/,"").replace(/\s\s*$/,"")};if(!window.outerXHTML)window.outerXHTML=window.xhtmljs.outerXHTML;if(!window.innerXHTML)window.innerXHTML=window.xhtmljs.innerXHTML;
